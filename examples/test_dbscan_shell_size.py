...
if __name__ == "__main__":
    ...
    best_eps = None
    best_mix_grid = None
    centers, _ = dd_optimal.dbscan_clusters(gmm=gmm)
    ...
    mix_grid = dd_optimal.create_grid_from_epsilon(gmm, centers, eps=best_eps)
    disc_mix, w2_mix = dd.discretize(gmm, mix_grid)
    ...
    ax.set_title(f'Optimal grid whole space for average Grid: {w2.item():.2f}')
    plt.show()

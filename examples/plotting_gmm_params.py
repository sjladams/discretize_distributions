...
df = pd.read_excel("benchmark_results/gmm_discretization_results_variance_test_2025-07-04_2.xlsx")
df = pd.read_excel("benchmark_results/gmm_discretization_results_higher_dims_test_2025-07-04_1.xlsx")

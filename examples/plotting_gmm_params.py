...
plt.plot(df_sorted["num_mix_elems"], df_sorted["w2_mix"], label="Multi-Grid", color='blue', alpha=0.6)
plt.plot(df_sorted["num_mix_elems"], df_sorted["w2_old"], label="Per Component", color='red', alpha=0.6)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("benchmark_results/nr_components.svg")
plt.show()

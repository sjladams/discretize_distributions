...
df = pd.read_excel("benchmark_results/gmm_2d_discretization_results_nr_components_test_2025-07-08_FINAL.xlsx")
...
df = pd.read_excel("benchmark_results/gmm_discretization_results_variance_test_2025-07-04_15D.xlsx")
...
plt.grid(True)
plt.tight_layout()
# plt.savefig("benchmark_results/variance_15D.svg")
plt.show()

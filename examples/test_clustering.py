...
if __name__ == "__main__":
    ...
    # mix_grid = dd_optimal.create_grid_from_centers(gmm, centers, stddev_factor=4)
    ...
    # _, centers_k, _ = dd_optimal.kmeans_shells(gmm=gmm, n_clusters=2)
    # mix_grid_k = dd_optimal.create_grid_from_centers(gmm, centers_k, stddev_factor=4)
    # disc_mix_k, w2_mix_k = dd.discretize(gmm, mix_grid_k)
    #
    # fig, ax = plt.subplots(figsize=(8, 8))
    # ax = plot_2d_dist(ax, gmm)
    ...
    #
    # fig, ax = plt.subplots(figsize=(6, 6))
    # plot_final_discretization_with_shells(ax, gmm, disc_mix_k, mix_grid_k)
    # plt.show()
    #

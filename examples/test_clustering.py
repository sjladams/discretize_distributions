...
if __name__ == "__main__":
    ...
    component_distribution = dd_dists.MultivariateNormal(loc=torch.tensor([[-6.0, -6.0], [7.0, 7.0], [7.0, 7.0]]),
                                                         covariance_matrix=torch.diag_embed(torch.tensor([[3., 1.], [2., 3.], [2., 2.]])))
    mixture_distribution = torch.distributions.Categorical(probs=torch.tensor([.5, .5, .5]))

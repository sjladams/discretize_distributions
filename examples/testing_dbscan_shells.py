...
if __name__ == "__main__":
    ...
    for s in spread_values:
        ...
        config = dict(
            loc=locs,
            covariance_matrix=torch.diag_embed(torch.tensor([[3., 1.], [1., 3.], [2., 2.]]))  # keep covariance constant
        )
        component_distribution = dd_dists.MultivariateNormal(**config)
        ...
        mix_grid = dd_optimal.dbscan_shells(gmm=gmm, plot=False)

...
if __name__ == "__main__":
    ...
    print(f'w2 (uniform grid): {w2_uniform.item()}')
    ...
    disc_mix, w2_mix, outer_loc_mass = dd.discretize(gmm, mix_grid)
    ...
    ax = set_axis(ax)
    ax.set_title(f'Mix schemes using optimal locations: {w2_mix.item():.2f}')
    plt.show()

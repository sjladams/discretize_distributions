...
Given a continuous distribution $p$ and a set of points $C = \{x_i\}_{i=1}^N$, we aim to construct a discrete distribution of the form  
$$
    d_{C} = \sum_{i=1}^N w_i \,\delta_{x_i},
$$
